...
- live voice input/output and interruption
- local and cloud intelligence routing
- persistent context foundations
- verified PC telemetry
- authorized file and application actions
- owner voice verification and liveness challenges
- centralized authorization and protected-action elevation

The private engineering repository remains separate. This public repository contains only the project site and intentionally public status information.
...
The site distinguishes verified current capabilities from future plans. Funding goals, when active, are tied to defined project milestones rather than presented as general-purpose donations.
